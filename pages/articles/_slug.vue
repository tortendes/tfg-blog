          ...
          <div class="flex">
            <div class="m-auto">
              ...
              <div class="flex items-center mt-3 max-w-xl px-3 lg:px-0">
                <img class="rounded" :src="require(`@/assets/authors/${article.author.image}`)" :alt="article.author.name + '\'s Photo'" width="50" height="50">
                <div class="ml-5">
              ...
              <div class="flex justify-end items-between">
                ...
                <a class="mr-3" :href="`http://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fblog.furrygalaxy.gq%2F${$route.path}&title=${article.title}%20by%20${article.author.name}%20•%20${article.minRead}%20min%20read`"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill:#2a2a2a;transform:;-ms-filter:"><path d="M20,3H4C3.447,3,3,3.448,3,4v16c0,0.552,0.447,1,1,1h16c0.553,0,1-0.448,1-1V4C21,3.448,20.553,3,20,3z M8.339,18.337H5.667 v-8.59h2.672V18.337z M7.003,8.574c-0.856,0-1.548-0.694-1.548-1.548s0.691-1.548,1.548-1.548c0.854,0,1.548,0.693,1.548,1.548 S7.857,8.574,7.003,8.574z M18.338,18.337h-2.669V14.16c0-0.996-0.018-2.277-1.388-2.277c-1.39,0-1.601,1.086-1.601,2.207v4.248 h-2.667v-8.59h2.56v1.174h0.037c0.355-0.675,1.227-1.387,2.524-1.387c2.704,0,3.203,1.778,3.203,4.092V18.337z" /></svg></a>
              </div>

              <div class="flex">
                <div class="m-auto">
                  <img :src="require(`@/assets/blog-assets/${article.image}`)" class="lg:rounded max-h-96 mt-20 mb-20" alt="">
                </div>
              </div>

              <nuxt-content :document="article" class="prose lg:prose-xl font-sans px-3 mt-5 mb-20" />
...
export default {
  ...
  head () {
    return {
      title: `${this.article.title} | The Furry Galaxy Blog`,
      meta: [
        {
          hid: 'theme-color',
        ...
        },
        {
          hid: 'og:image',
          property: 'og:image',
          content: `https://tfg-blog.herokuapp.com/wp-static/${this.article.image}`
        },
        {
          hid: 'twitter:card',
          name: 'twitter:card',
        ...
        },
        {
          hid: 'twitter:url',
          name: 'twitter:url',
          content: `https://tfg-blog.herokuapp.com/articles/${this.article.slug}`
        },
        {
          hid: 'twitter:title',
          name: 'twitter:title',
      ...
      link: [
        {
          hid: 'canonical',
          rel: 'canonical',
          href: `https://tfg-blog.herokuapp.com/articles/${this.article.slug}`
        }
      ]
    }
  }
